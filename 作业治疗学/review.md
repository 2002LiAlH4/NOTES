...
认知：泛指个人接收利用外界信息，从而适应外来环境要求的基本能力。

### 第二节 基础认知功能障碍

基础认知功能包括：定向力、注意力和记忆

定向力：是个体对时间、地点、人等的自我察觉能力。

一、定向力障碍
（一）评定：盖尔维斯顿定向力测验（Benton Temporal Orientation Test,GOAT）,本顿时间定向力测验（Benton Temporal Orientation Test,BTOT），简易智能精神状态检查表（MMSE）、蒙特利尔认知评定量表（MoCA）
（二）作业治疗
1. 现实定向疗法
2. 团体现实定向力疗法
3. 认知刺激疗法
...
高级认知功能主要指执行功能，具体包括计划、词语流畅性、工作记忆、反应抑制即转移。
计划：包括很多过程，比如决策、问题解决、判断、对自己和他人的行为做出评价等。
词语流畅：指能够回忆并说出或写出某一类别的词语。
工作记忆：指暂时储存和加工信息的一个大脑系统。
反应抑制：指在陌生或不明确的情境下拒绝习惯性、趋近性行为的能力，可以包括运动抑制、认知抑制、动机抑制、注意抑制、干扰控制等。
定势转移：指在不同任务或不同操作之间灵活转换的能力。

### 第四节 

知觉：是人脑对直接作用于感觉器官的客观事物整体属性的综合反应。

视觉感知失调包括空间关系失调、物体识别失调、主客体关系失调、深度感知失调。

失认症：指患者不能认识经由某一感觉（如视觉、听觉和触觉）辨察的事物。这种对感知对象的认识障碍并不是由于感觉、语言、智能和意识障碍所引起，也不是因为不熟悉这些物体所造成，而是由于脑部受损使患者对经由**视觉、听觉和触觉**等途径获得的信息丧失了正确的分析和识别能力，即**感觉皮质整合功能**发生了障碍。
1. 单侧忽略：又称半边不注意，症状表现为患者对脑损害部位对侧的身体和空间内的物体不能辨认。
评定：①Albert试验②字母删除试验
2. 躯体失认症：躯体失认的患者否认瘫痪，不承认自己瘫痪的手和脚。患者常误以为是他人身体的一部分或不承认是自己肢体的一部分。评定依靠临床表现。
3. 格斯特曼综合征（Gerstmann综合征）：表现为不能正常的书写计算，左右定向的障碍以及认识不能。
①左右混淆：轻患者举起一侧肢体，回答错误即阳性
②手指失认：指出相应的手指，回答错误即为阳性
③失写症：写出口述的句子，不能写即为阳性
④失算症：心算、笔算均为障碍
4. 视觉失认症：指患者尽管视觉正常，但不能认识物品，颜色和熟人的脸。包括**物体失认、面容失认、颜色失认、同时失认**
5. 触觉失认症

失用症：是由于**中枢神经**损伤后，在**运动、感觉和反射**均无障碍的情况下，不能按命令完成原先学过的动作的一种症状。这一情况并非因**肌肉瘫痪、感觉缺失、共济失调或理解障碍**造成，而是由于大**脑皮质**受损，导致皮质所储存的运动程序的提取出现紊乱，从而对其所接受到的外周刺激不能调动相应的程序予以应答。
结构性失用症、穿衣失用症、意念运行性失用症、意念性失用症

### 第五节 认知训练

认知训练模式包括：基本能力训练、认知功能技巧训练、环境改良

## 第八章 

压力治疗：又称加压疗法，是指通过对人体体表施加适当的压力，以预防或抑制皮肤瘢痕增生，防治肢体肿胀的治疗方法。

## 第九章

辅助技术：是指用来帮助残疾人、老年人进行功能代偿以促进其独立生活并充分发挥他们潜力的多种**技术、服务和系统**的总称。

- 技术：硬件（器具）、软件（方法）
- 服务：适配服务和供应服务
- 系统：研发、生产、供应、服务、管理

助行器：辅助人体支撑体重、保持平衡和行走的器具。主要作用：保持身体平衡，减少下肢承重，缓解疼痛，改善步态，改善步行功能。
